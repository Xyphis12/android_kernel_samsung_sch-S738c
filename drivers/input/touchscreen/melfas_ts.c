...
static int melfas_ts_resume(struct i2c_client *client)
{
	...
	msleep(50);
	mms_set_noise_mode(ts);
#ifndef CONFIG_MACH_KYLE_I	/* not use Kyle-i TSP firmware */
#ifndef CONFIG_MACH_KYLE /*temporary*/
	ret = melfas_i2c_read(ts->client, 0xb1,
			1, read_data_buf);
