...
static struct proccomm_regulator_info msm7x27a_pcom_vreg_info[] = {
	...
	/* minimum voltage is changed from 3.3 V to 3 V */
	PCOM_VREG_LDO(ldo01, 5,  NULL, 2800000, 2800000, 0, -1, 0, 0, 0, 0, p),
	...
	PCOM_VREG_LDO(ldo14, 16, NULL, 3000000, 3300000, 0, -1, 0, 1, 0, 0, p),
	PCOM_VREG_LDO(ldo15, 54, NULL, 1800000, 1800000, 0, -1, 0, 0, 0, 0, p),
	PCOM_VREG_LDO(ldo16, 19, NULL, 3000000, 3000000, 0, -1, 0, 1, 0, 0, p),
	PCOM_VREG_LDO(ldo17, 56, NULL, 2800000, 2800000, 0, -1, 0, 0, 0, 0, p),
